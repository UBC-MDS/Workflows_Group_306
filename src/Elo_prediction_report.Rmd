...
ELO rating is a relative ranking system, in which participants gain points by winning/performing better then expected, and have their ranking reduced when they lose/perform worse then expected.
The system was originally invented by Arpad Elo for the world of chess and has since gained popularity in a few competitive sports as well as online games particularly team games*.
