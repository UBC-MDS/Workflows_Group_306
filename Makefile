...
data/lr_score.csv data/rf_score.csv img/disp_rf.png img/disp_lr.png : src/model.py data/elo_historic_wrangled.csv data/elo_2019_wrangled.csv
	python src/model.py --train_file=data/elo_historic_wrangled.csv --test_file=data/elo_2019_wrangled.csv

Elo_prediction_report.md : src/Elo_prediction_report.Rmd data/lr_score.csv data/rf_score.csv img/disp_rf.png img/disp_lr.png img/eda-ELO_update_with_result.png
